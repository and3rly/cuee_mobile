...
public class clsBeServicios_instalado {
    ...
    public Integer IdInstalacion = 0;
    public Integer IdUsuarioServicio = 0;
    public String IdContador = "";
    public Integer IdVoltaje = 0;
    public Integer IdPotencia = 0;
    public Integer IdTransformador = 0;
    public Integer IdTipoServicio = 0;
    public String Fecha = "";
    public String Hora = "";
    public Integer IdTecnico = 0;
    ...
    public Integer Subestacion = 0;
    public Integer Id_circuito = 0;
    public String IdGPS = "";
    public String IdFotografia = "";
    public String Direccion = "";
    public Integer IdMunicipio = 0;
    public Integer IdDepartamento = 0;
    public String Zona = "";
    ...
    public String Fases_de_conexion = "";
    public String Acometida_subt_area = "";
    public Integer Long_cable_acom = 0;
    ...
    public String Voltaje_medidor = "";
    public Integer Voltaje_suministro = 0;
    public String Corriente_nominal = "";
    public String Corriente_maxima = "";
    public String Kh = "";
    public String Rr = "";
    public String Fecha_puesto_servicio_m = "";
    public String Fecha_retiro_medidor = "";
    public double Coor_x = 0.0;
    public double Coor_y = 0.0;
    public String Zona_utm_medidor = "";
    public String Fecha_ultimo_pago = "";
    public double Numero_contrato = 0.0;
    public String Fecha_contrato = "";
    public String Hora_contrato = "";
    public boolean Servicio_bajo_demanda = false;
    public double Kw_contratada = 0.0;
    public double Potencia_contratada = 0.0;
    public String Ruta = "";
    public Integer Itinerario = 0;
    public Integer IdUsuario = 0;
    public String Fecha_creacion = "";
    public Integer Idusuario_modifica = 0;
    public String Fecha_modificacion = "";
    public boolean Activo = false;
    public Integer Estado_servicio = 0;
    ...
    public Integer getIdUsuarioServicio() {
        return IdUsuarioServicio;
    }

    public void setIdUsuarioServicio(Integer idUsuarioServicio) {
    ...
    public Integer getIdVoltaje() {
        return IdVoltaje;
    }

    public void setIdVoltaje(Integer idVoltaje) {
        IdVoltaje = idVoltaje;
    }
    ...
    public void setContador_siguiente(String contador_siguiente) {
        Contador_siguiente = contador_siguiente;
    }
    ...
    public void setUsuario_siguiente(String usuario_siguiente) {
        Usuario_siguiente = usuario_siguiente;
    }
    ...
    public void setModificacion_red(boolean modificacion_red) {
        Modificacion_red = modificacion_red;
    }
    ...
    public void setId_poste_inicio(String id_poste_inicio) {
        Id_poste_inicio = id_poste_inicio;
    }
    ...
    public void setTension_nominal_acom(String tension_nominal_acom) {
        Tension_nominal_acom = tension_nominal_acom;
    }

    public String getFases_de_conexion() {
        return Fases_de_conexion;
    }

    public void setFases_de_conexion(String fases_de_conexion) {
        Fases_de_conexion = fases_de_conexion;
    }

    public String getAcometida_subt_area() {
        return Acometida_subt_area;
    }

    public void setAcometida_subt_area(String acometida_subt_area) {
        Acometida_subt_area = acometida_subt_area;
    }

    public Integer getLong_cable_acom() {
        return Long_cable_acom;
    }

    public void setLong_cable_acom(Integer long_cable_acom) {
        Long_cable_acom = long_cable_acom;
    }
    ...
    public void setTipo_de_conductor(String tipo_de_conductor) {
        Tipo_de_conductor = tipo_de_conductor;
    }
    ...
    public void setFecha_puesto_servicio(String fecha_puesto_servicio) {
        Fecha_puesto_servicio = fecha_puesto_servicio;
    }
    ...
    public void setFecha_retiro_acom(String fecha_retiro_acom) {
        Fecha_retiro_acom = fecha_retiro_acom;
    }
    ...
    public void setNum_serie_medido(String num_serie_medido) {
        Num_serie_medido = num_serie_medido;
    }
    ...
    public String getVoltaje_medidor() {
        return Voltaje_medidor;
    }

    public void setVoltaje_medidor(String voltaje_medidor) {
        Voltaje_medidor = voltaje_medidor;
    }

    public Integer getVoltaje_suministro() {
        return Voltaje_suministro;
    }

    public void setVoltaje_suministro(Integer voltaje_suministro) {
        Voltaje_suministro = voltaje_suministro;
    }

    public String getCorriente_nominal() {
        return Corriente_nominal;
    }

    public void setCorriente_nominal(String corriente_nominal) {
        Corriente_nominal = corriente_nominal;
    }

    public String getCorriente_maxima() {
        return Corriente_maxima;
    }

    public void setCorriente_maxima(String corriente_maxima) {
    ...
    public void setFecha_puesto_servicio_m(String fecha_puesto_servicio_m) {
        Fecha_puesto_servicio_m = fecha_puesto_servicio_m;
    }
    ...
    public void setFecha_retiro_medidor(String fecha_retiro_medidor) {
        Fecha_retiro_medidor = fecha_retiro_medidor;
    }
    ...
    public void setZona_utm_medidor(String zona_utm_medidor) {
        Zona_utm_medidor = zona_utm_medidor;
    }
    ...
    public void setServicio_bajo_demanda(boolean servicio_bajo_demanda) {
        Servicio_bajo_demanda = servicio_bajo_demanda;
    }
    ...
    public Integer getIdusuario_modifica() {
        return Idusuario_modifica;
    }

    public void setIdusuario_modifica(Integer idusuario_modifica) {
    ...
    public void setServicio_bajo_demandafp(boolean servicio_bajo_demandafp) {
        Servicio_bajo_demandafp = servicio_bajo_demandafp;
    }
    ...
    public void setEs_autoproductor(boolean es_autoproductor) {
        Es_autoproductor = es_autoproductor;
    }
}
