...
public class clsBePagos_detalle_rep {
    ...
    public String nombreusuarioservicio = "";
    public String nocontador = "";
    public String nomarchamo = "";
    public String tiposervicio = "";
    public String tipotarifa = "";
    public int nomes = 0;
    public int año = 0;
    public double voltios = 0;
    public double lectura_anterior = 0;
    public double lectura_actual = 0;
    public double consumo = 0;
    public String fecha_inicio = "";
    public String fecha_fin = "";
    public int dias_facturados = 0;
    public String mes_operacion = "";
    public String fecha_emision = "";
    public double cargo_fijo = 0;
    public double consumo_energia_ts = 0;
    public double importe_ts = 0;
    public double consumo_energia_tns = 0;
    public double importe_tns = 0;
    public double consumo_energia_total = 0;
    public double importe_consumo_total = 0;
    public double alumbrado_publico = 0;
    public String fecha_sistema = "";
    public double potencia_contratada = 0;
    public double potencia_maxima = 0;
    public double importe_potencia_maxima = 0;
