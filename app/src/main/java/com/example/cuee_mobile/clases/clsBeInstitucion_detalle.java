...
public class clsBeInstitucion_detalle {
    ...
    private int IdPeriodoParametros = 0;
    ...
    private int IdUsuarioCreo = 0;
    private String Fecha_Creacion = "";
    private String Fecha_Modificacion = "";
    private int IdUsuarioModifico = 0;
    ...
    private double Precio_luz_autoproductor = 0.0;
    private double Cargo_fijo_autoproductor = 0.0;
    ...
    public void setPrecio_luz_autoproductor(double precio_luz_autoproductor) {
        Precio_luz_autoproductor = precio_luz_autoproductor;
    }
    ...
    public void setCargo_fijo_autoproductor(double cargo_fijo_autoproductor) {
        Cargo_fijo_autoproductor = cargo_fijo_autoproductor;
    }
}
